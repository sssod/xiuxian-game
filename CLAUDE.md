...
This file provides guidance to Claude Code when working with the Xiuxian Game project.
...
- Keep bootstrap work aligned with `orchestration/project-index/xiuxian-game/bootstrap-spec.yaml`.
