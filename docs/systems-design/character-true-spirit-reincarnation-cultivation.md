...
S2 负责当世角色成长、跨世真灵连续性、修炼、功法掌握、资源输入、突破结果、死亡、转世、轮回账本和后手关联。
...
玩家控制的是跨世真灵，当世角色是一次生命的载体。

| 层级 | 负责内容 | 跨世处理 |
| --- | --- | --- |
| 真灵 | 跨世身份、轮回账本、因果痕迹、已知后手、暴露等级 | 持续存在 |
...
转世不是清空进度。它应把本世失败原因、关键选择、后手、传闻、因果痕迹和可继承线索转化为下一世可理解、可利用、可修正的信息。
...
| 真灵强度直接稳定提高修炼效率 | 废弃 | 真灵提供长期身份、轮回账本、因果与后手容量，不作为默认效率外挂 |
...
| 采用方案 | 废弃方案 | 原因与实现影响 |
| --- | --- | --- |
| 真灵与当世角色分层 | 玩家控制固定角色或宗门本体 | 支持死亡、转世、后手和跨世账本 |
...
| 死亡转世写入 `LifeLedger` / `ReincarnationRecord` | 死亡后简单重开 | 失败需要转化为下一世信息、后手和修正方向 |
