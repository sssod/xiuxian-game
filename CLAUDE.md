...
This file provides project guidance for Claude Code and other coding agents working in `xiuxian-game`.
...
Do not use files outside this project root as project authority.
