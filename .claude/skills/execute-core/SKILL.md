---
name: execute-core
description: Core operating behavior for orchestration `execute` tasks. Use when a task must deliver a concrete code, config, docs, or operational change directly. Triggers alongside scenario-specific execute skills such as follow-up-test handoff, failure repair, compatible migration, safe refactor, or batch review.
---
